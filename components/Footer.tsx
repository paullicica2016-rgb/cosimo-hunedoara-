          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-[#4caf50] font-medium text-xs">{t('Nonstop 24/7', 'Open 24/7')}</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:0724004415" className="hover:text-white transition-colors">0724 004 415</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-[#FFC107] text-xs font-medium">{t('Comenzi telefonice', 'Phone orders')}</span>
              </li>
            </ul>
          </div>
        </div>
